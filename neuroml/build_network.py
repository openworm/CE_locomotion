...
def run(a = None, **kwargs):
    ...
    if population_structure == 'one population':  #all cells in a single population
        ...
        for index, connection in enumerate(chemical_weights): 
            ...
            pre_cell_id = utils.get_cell_id_string_full(population_structure, pop0.id, pop0.component, pre_index)
            post_cell_id = utils.get_cell_id_string_full(population_structure, pop0.id, pop0.component, post_index)
